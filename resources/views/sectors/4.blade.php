		...
		<div class="container">	
			<div class="row">
				<div class="col-md-9">
					...
					<div class="col-md-8">
						<img style="max-height: 400px ; margin: 20px auto ;" src="{{ asset('images/sectors/body/call-center.jpg') }}" class="img img-responsive img-thumbnail">
					</div>
