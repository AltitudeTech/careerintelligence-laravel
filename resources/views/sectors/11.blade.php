...
@section('title','Fast Moving Consumer Goods')
		...
		<div class="container">	
			<div class="row">
				<div class="col-md-9">
					...
					<div class="row">	
						<img style="max-height: 400px ; margin: 20px auto ;" src="{{ asset('images/sectors/body/fast-moving-consumer-goods.jpg') }}" class="img img-responsive img-thumbnail">
					</div>
