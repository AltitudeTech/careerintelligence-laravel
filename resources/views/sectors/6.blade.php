...
@section('css')
	...
	<style type="text/css">
		.banner1 {
		    background: url({{ asset('images/sectors/digitaltechnology.jpg')}}) no-repeat  0px 0px;
		...
		<div class="container">	
			<div class="row">
				<div class="col-md-9">
					...
					<div class="col-md-8">
						<img style="max-height: 400px ; margin: 20px auto ;" src="{{ asset('images/sectors/body/digital-technology.jpg') }}" class="img img-responsive img-thumbnail">
					</div>
