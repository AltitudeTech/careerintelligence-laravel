...
@section('css')
	...
	<style type="text/css">
		.banner1 {
		    background: url({{ asset('images/candidate-x.jpg')}}) no-repeat  0px 0px;
					...
					<div class="col-md-9">
							<div class="row">
								<style>
									...
									<div style="margin-top: 40px;">
										{!! Form::open(['action' => 'RecruitingController@store' , 'method'=>'POST']) !!}
											...
											<div class="col-md-12">
												<fieldset class="form-group">
													<label for="jobTitle"><span class="text-danger">*</span>Phone</label>
								...
								<div class="row" style="text-align:center">
									<img src="{{asset('images/candidate-bottom-page.png')}}" class="thumbnail" alt="">
								</div>
							</div>
					<div class="col-md-3">
						@include('serviceside')
