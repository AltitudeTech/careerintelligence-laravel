...
@section('title','Hire Select')

@section('css')
	@parent
	<style type="text/css">
		.banner1 {
		    background: url({{ asset('images/partner/hireselect.png')}}) no-repeat  0px 0px;
			...
			<div class="row">
					<div class="col-md-9">
						...
						<div class="row" style="margin-top: 30px ;">	
							<img style="width: 30% ; float: left ; margin: 0px 20px 20px 0px ;" class="img img-responsive img-thumbnail" src="{{ asset('images/partner/hireselectb2.jpg') }}" alt="">
							<p style="line-height: 30px ;  letter-spacing: 1px ; text-align: justify;">
								Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
								tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
								quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
