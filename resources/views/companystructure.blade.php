...
@section('css')
	...
	<style type="text/css">
		.banner1 {
		    background: url({{ asset('images/companystructure.jpg')}}) no-repeat  0px 0px;
		...
		<div class="container">	
			<div class="row">
					<div class="col-md-9">
						...
						<div class="row">	
							<img style="max-height: 400px;" src="{{ asset('images/managementb.jpg') }}" class="img img-responsive img-thumbnail">
							<p>
								Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
								tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
								quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
