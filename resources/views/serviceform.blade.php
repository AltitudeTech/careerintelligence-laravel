<form class="form-horizontal"  method="POST">
  <fieldset>
    ...
    <div class="control-group">
      <label class="control-label pull-left"  for="username">First Name</label>
        <input type="text" id="username" name="username" placeholder="" class="input-xlarge pull-right">
        <div class="clearfix"></div>
    </div>

    <div class="control-group">
      <label class="control-label pull-left"  for="username">Last Name</label>
        <input type="text" id="username" name="username" placeholder="" class="input-xlarge pull-right">
        <div class="clearfix"></div>
    </div>
    ...
    <div class="control-group">
      <label class="control-label pull-left"  for="username">Sector</label>
        <select style="" class="input-xlarge pull-right">
